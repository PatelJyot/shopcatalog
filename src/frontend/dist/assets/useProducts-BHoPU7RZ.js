...
import { g as Subscribable, p as pendingThenable, h as resolveEnabled, s as shallowEqualObjects, i as resolveStaleTime, n as noop, k as environmentManager, l as isValidTimeout, t as timeUntilStale, m as timeoutManager, o as focusManager, q as fetchState, v as replaceData, w as notifyManager, r as reactExports, x as shouldThrowError, y as useQueryClient, c as createLucideIcon, j as jsxRuntimeExports, z as cn, e as useCart, L as Link, B as Badge, a as Button, S as ShoppingCart, f as ue, M as MOCK_PRODUCTS } from "./index-CbaAsIMs.js";
...
function useProductsByCategory(category) {
  return useQuery({
    ...
    queryFn: async () => category === "All" ? MOCK_PRODUCTS : MOCK_PRODUCTS.filter((p) => p.category === category),
    staleTime: 5 * 60 * 1e3
  });
}
function useDeals() {
