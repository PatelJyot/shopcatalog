...
export default function CategoryPage() {
  ...
  const sortBy = (searchParams.sort ?? "relevance") as SortOption;
  const selectedBrands = searchParams.brands
  ...
  return (
    <div className="bg-background min-h-screen" data-ocid="category.page">
      {/* Page header */}
            ...
            <div>
              ...
              {!isLoading && total > 0 && (
                <p className="text-sm text-muted-foreground mt-0.5">
                  ...
                  {total.toLocaleString()} results in {name}
                </p>
              )}
            </div>
